...
import 'package:untitled4/dashboard/resumeform.dart';
...
import 'ResumePreviewWidget.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildTextFormField(
                      ...
                      onChanged: (String value) => resumeData.jobTitle = value,
                      textInputAction: TextInputAction.next,
                    ),
                    _buildTextFormField(
                      ...
                      onChanged: (String value) => resumeData.company = value,
                      textInputAction: TextInputAction.next,
                    ),
                    _buildTextFormField(
                    ...
                    _buildTextFormField(
                      ...
                      onChanged: (String value) => resumeData.degree = value,
                      textInputAction: TextInputAction.next,
                    ),
                    _buildTextFormField(
                      ...
                      onChanged: (String value) => resumeData.university = value,
                      textInputAction: TextInputAction.next,
                    ),
                    _buildTextFormField(
                    ...
                    _buildTextFormField(
                      ...
                      onChanged: (String value) => resumeData.skills = value,
