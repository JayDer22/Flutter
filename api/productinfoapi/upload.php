...
$upload_url = 'https://'.$_SERVER['SERVER_NAME'] . "/projectapi/productapi/" . $upload_path;

//echo $upload_url;

//getting name from the request
$cname = $_REQUEST['product_name'];
...
$sql = "INSERT INTO product_info(product_name,product_image) VALUES ('$cname','$file_url')";
//echo $sql;
//exit;
